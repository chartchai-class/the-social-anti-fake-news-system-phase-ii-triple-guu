...
import se331.lab.entity.RoleType;
...
public class AuthenticationService {
  ...
  // organizerRepository removed as organizer domain was deleted
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    UserEntity user = UserEntity.builder()
      ...
      .profileImage(request.getOrgImage()) // or request.getProfileImage() if available
      .build();
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      UserEntity user = this.repository.findByUsername(userEmail)
        .orElseThrow();
